...
Environment=PI_SIGNAL_QUIET_DAEMON=true
...
SERVICE_EOF
	...
	echo "    export PI_SIGNAL_PRIMARY=true"
	echo ""
	echo "  If you haven't installed the pi package yet, install it from npm:"
	echo ""
	echo "    pi install @aalzubidy/pi-signal"
	echo ""
